...
import StaffOrder from  "./stafforders";
  ...
  return (
    <div className="flex h-screen bg-gray-900 overflow-hidden">
      ...
      <div className="flex-shrink-0">
        <StaffSidebar onMenuSelect={setSelected} />
      </div>
      ...
      <div className="flex-1 flex flex-col min-h-0">
        ...
        <div className="flex-1 overflow-y-auto bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
          <div className="p-4 sm:p-6 lg:p-8">
            {selected === "stafforders" && <StaffOrder/>}
            {selected === "tables" && <Tables />}
             {selected === "orderhistory" && <OrderHistory />}
           {selected === "Report" && <ReportsAndAnalysis/>}
          {selected === "staffshift" && <StaffShift/>}
